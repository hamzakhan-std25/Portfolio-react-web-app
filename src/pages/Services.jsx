          ...
          <div className="row g-4">
            {services.map(service => (
              <div key={service.id} className="col-md-4">
                <div className={`card h-100 shadow-sm border-0 ${isDarkMode ? 'bg-secondary text-white' : ''}`}>
      ...
      <section className="py-5 bg-primary bg-gradient text-white text-center">
        <div className="container">
          <blockquote className="blockquote mb-0">
            ...
            <footer className="blockquote-footer text-white mt-2">— Satisfied Client</footer>
          </blockquote>
        </div>
      </section>
        ...
        <div className="container text-center">
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className={`p-4 border rounded ${isDarkMode ? 'bg-secondary text-white' : 'bg-light'}`}>
